...
Student.prototype.logMe = function(showClub) {
	 ...
	 */
		...
		for (i=0; i<range; i++)		
		{
			returnString += Object.values(this)[i] + " - ";
		}
	    // trim the trailing " - " from return value
...
// This implementation of Bubble Sort inspired by Amir Popovich verions at
//  https://stackoverflow.com/questions/37817334/javascript-bubble-sort
function bubbleSort(comparator, arr) 
{
    var len = arr.length;
